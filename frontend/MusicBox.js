...
let MusicBox = class MusicBox extends _react2.default.Component {
  constructor() {
    super();
    this.state = {
      deltaPosition: {
  ...
  render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { style: rec_button_style, onClick: this.startStopRecording },
          this.state.recordingLabel
        ),
        _react2.default.createElement(
          _reactDragAndDrop.Draggable,
          { type: 'music', data: this.props.p_data.music_one,
            style: div_element_style },
          'drag music1'
        ),
        _react2.default.createElement(
          _reactDragAndDrop.Draggable,
          { type: 'music', data: this.props.p_data.music_two,
        ...
        _react2.default.createElement(
          _reactDragAndDrop.Draggable,
          { type: 'music', data: this.props.p_data.music_tree,
        ...
        _react2.default.createElement(
          _reactDragAndDrop.Draggable,
          { type: 'music', data: this.props.p_data.music_four,
        ...
        _react2.default.createElement(
          _reactDragAndDrop.Draggable,
          { type: 'music', data: this.props.p_data.music_five,
      ...
      _react2.default.createElement(
        ...
        { types: ['music'] //allowed drop types
