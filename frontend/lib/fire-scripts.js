...
PianoRock.prototype.playNote = function (note) {
  switch (note) {
    case '2':
      tones.play('c#', 5);break;
    case '3':
      tones.play('d#', 5);break;
    case '5':
      tones.play('f#', 5);break;
    case '6':
      tones.play('g#', 5);break;
    case '7':
      tones.play('a#', 5);break;
    case '9':
      tones.play('c#', 6);break;
    case '0':
      tones.play('d#', 6);break;
    case 'q':
      tones.play('c', 5);break;
    case 'w':
      tones.play('d', 5);break;
    case 'e':
      tones.play('e', 5);break;
    case 'r':
      tones.play('f', 5);break;
    case 't':
      tones.play('g', 5);break;
    case 'y':
      tones.play('a', 5);break;
    case 'u':
      tones.play('b', 5);break;
    case 'i':
      tones.play('c', 6);break;
    case 'o':
      tones.play('d', 6);break;
    case 'p':
      tones.play('e', 6);break;
    default:
  }
};
